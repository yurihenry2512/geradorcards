...
<form name="form" method="post" action="card2.php" id='formulariocadas'>
    <div class="container">
        <div class="mt-3">
            <h1>Cards Massiva B2B - Finalização de Card</h1>
        </div>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            <input type="txt" class="form-control" id="exampleFormControlInput1" name="normalizacao" placeholder="Final do Evento">
        </div>
        ...
        <div class="mb-3">
         ...
         <div class="mb-3">
            <input type="txt" class="form-control" id="exampleFormControlInput1" name="acao_de_normalizacao" placeholder="Ação de Normalização da Falha">
        </div>

      <!--  <div class="mb-3">
	        <label for="exampleFormControlSelect2">Exemplo de select múltiplo</label>
			    <select multiple class="form-control" id="exampleFormControlSelect2" name="teste">
			      <option value="1">yuri</option>
			      <option value="2">henry</option>
			      <option value="3">sousa</option>
